...
@push('scripts')
<script>
    function openDialog(id = null, name = '', status = true) {
    ...
    $(function() {
        ...
        var columnsConfig = [
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    var deleteUrl = '{{ route("regions.destroy", ":id") }}'.replace(':id', row.id);
        ...
        initializeAdminDataTable('#regionTable', '{{ route("regions.index") }}', columnsConfig, '#searchForm', [[0, 'desc']]);
    });
</script>
@endpush
