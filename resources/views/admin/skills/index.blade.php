...
<div class="card shadow-sm border-0">
    <div class="card-body">
        ...
        <div class="table-responsive text-nowrap rounded-3 border">
            <table class="table table-hover mb-0" id="skillTable">
...
<script>
    ...
    $(function() {
        ...
        var columnsConfig = [
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    var deleteUrl = '{{ route("skills.destroy", ":id") }}'.replace(':id', row.id);
                    
                    var deleteBtn = '<form action="' + deleteUrl + '" method="POST" class="d-inline" onsubmit="return confirm(\'Are you sure you want to delete this skill?\');">' +
        ...
        initializeAdminDataTable('#skillTable', '{{ route("skills.index") }}', columnsConfig, '#searchForm', [[0, 'desc']]);
    });
</script>
@endpush
