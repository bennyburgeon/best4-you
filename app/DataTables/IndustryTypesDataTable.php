...
class IndustryTypesDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($row) {
                return view('admin.industry-types.partials.actions', ['row' => $row])->render();
            })
    ...
    {
        return 'IndustryTypes_' . date('YmdHis');
    }
}
